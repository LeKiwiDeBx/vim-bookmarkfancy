...
"structure couleurs
"{"nom_couleur_bm":{"fg_term":"ctermfg","fg_gui":"guifg"}}
let g:bmfcolors={"blue":{"fg_term":"21","fg_gui":"#0000FF"}}
"structure du dictionnaire
"{numero_de_ligne:{"bmf_char":"caractère du bookmark","bmf_col" :"couleur","bmf_txt": "texte"}}
"structure texte
"pas de structure nécessaire a ce moment
let g:bookmarkfancy = {}
"test de la structure
let g:bookmarkfancy= {1:{"bmf_char":"B","bmf_col" :"blue", "bmf_txt": "LE TEXTE"}}
